  ...
  return (
    <>
      ...
      <button
        ...
        title="Website Intro"
      >
        <Image src="/logo-music.svg" alt="music" width={18} height={18} className={styles.triggerIcon} />
      ...
      <div className={`${styles.overlay} ${open ? styles.overlayOpen : ''}`}>
        ...
        <div className={styles.panel}>
          ...
          <div className={styles.header}>
            <Image src="/logo-music.svg" alt="logo" width={28} height={28} className={styles.headerIcon} />
            <div>
          ...
          <div className={styles.tableWrap}>
            ...
            {INTERACTIONS.map((row, i) => (
              <div key={i} className={styles.tableRow} style={{ '--i': i } as React.CSSProperties}>
          ...
          <div className={styles.footer}>
            <span className={styles.footerText}>POWERED BY &nbsp;THREE.JS · RAPIER · WEB AUDIO API · NEXT.JS</span>
